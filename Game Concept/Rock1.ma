...
//Name: Rock1.ma
//Last modified: Wed, Nov 08, 2017 11:24:16 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".t" -type "double3" 11.520419946574862 6.66876463301341 3.4118448528963654 ;
	setAttr ".r" -type "double3" 333.26164727390665 -1011.399999998673 -4.3583955162087369e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9782D050-4246-7DC1-95B9-569556D9DC10";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.936459503756442;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.4267712494100389 1.748266631799422 -0.15191710182322238 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "455B9A4D-4630-2D54-8F0E-1E97A472133A";
	setAttr ".t" -type "double3" 2.426771249410038 1000.3658819665388 -0.15191710182300078 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "CD25069C-4E86-4FF6-DFF5-44A427078552";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 998.61761533473918;
	setAttr ".ow" 44.039889494499164;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" 2.4267712494100353 4.32621389981432 1002.6736166948934 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "4991A442-4AAF-CDC9-5B07-78ABF20873CB";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1002.8255337967166;
	setAttr ".ow" 6.7283283289082432;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" 2.4267712494100353 4.3262138998143174 -0.15191710182322282 ;
	setAttr ".hc" -type "string" "viewSet -f %camera";
	setAttr ".o" yes;
createNode transform -s -n "side";
	rename -uid "7D39DBBD-46B1-3125-0DD0-738780A19466";
	setAttr ".t" -type "double3" 1003.2950690267235 1.7482666317994218 -0.15191710182300014 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "1A518737-4730-0849-A7F3-F89285F523FA";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.8682977773132;
	setAttr ".ow" 38.940799151779053;
...
createNode transform -n "pasted__pCube2" -p "group";
	...
	setAttr ".t" -type "double3" -1.495084170228429 -2.4785902353731459 -16.718950588513206 ;
	setAttr ".s" -type "double3" 3.1048052662372596 2.2267843314835796 1.9750535748936775 ;
createNode mesh -n "pasted__pCubeShape2" -p "pasted__pCube2";
	rename -uid "3A65E223-4B8F-BE43-31C4-508C5F7D9912";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.76537048816680908 0.39151269197463989 ;
	...
	setAttr -s 18 ".pt";
	setAttr ".pt[1]" -type "float3" -0.0015112333 0.041682325 -0.14183466 ;
	setAttr ".pt[6]" -type "float3" -3.3178367e-008 -3.7252903e-009 -4.4703484e-008 ;
	setAttr ".pt[7]" -type "float3" -0.14730591 0.11922533 0.15165938 ;
	setAttr ".pt[8]" -type "float3" -0.055991676 0.071752623 0.13152081 ;
	setAttr ".pt[12]" -type "float3" 0.040817451 -3.7252903e-009 -0.0010747919 ;
	setAttr ".pt[15]" -type "float3" 0.0016791697 -0.046314292 0.15759614 ;
	setAttr ".pt[21]" -type "float3" -0.14771239 0.17488843 0.11350991 ;
	setAttr ".pt[22]" -type "float3" -0.14714995 0.15841496 0.16629522 ;
	setAttr ".pt[23]" -type "float3" 0.0022936023 0.05318037 0.21526283 ;
	setAttr ".pt[26]" -type "float3" -0.05460503 -0.081625678 -0.29826975 ;
	setAttr ".pt[27]" -type "float3" -0.00087939372 0.13864812 -0.082534231 ;
	setAttr ".pt[28]" -type "float3" -0.19760966 5.5511151e-017 0.005203173 ;
	setAttr ".pt[29]" -type "float3" -0.028781781 -0.01898694 0.20654604 ;
	setAttr ".pt[30]" -type "float3" -0.14714995 0.15841496 0.16629522 ;
	setAttr ".pt[44]" -type "float3" -0.031899408 -0.021674642 -0.0072570024 ;
	setAttr ".pt[51]" -type "float3" 0.0019667635 -0.054246601 0.18458776 ;
	setAttr ".pt[52]" -type "float3" -0.00067389244 0.018587071 -0.063247301 ;
	setAttr ".pt[53]" -type "float3" 0.0011342558 0.17172457 0.10645399 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DA8EEE27-4BB0-CB79-C5F3-2A9D5067360A";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5BF8ACBB-4AEA-D780-743A-ECA5498E9092";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2D2FFB75-4234-D650-16A6-7C853F5C23E4";
createNode displayLayerManager -n "layerManager";
	rename -uid "3465428E-4E16-821A-F7B1-31BE28302FC6";
createNode displayLayer -n "defaultLayer";
	rename -uid "66365728-484F-D6A7-27E2-ABADE6D3618E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "67375C4A-4A12-EF4B-C545-B58EC896946A";
