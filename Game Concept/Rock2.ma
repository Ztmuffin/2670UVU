...
//Name: Rock2.ma
//Last modified: Wed, Nov 08, 2017 11:23:11 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".t" -type "double3" 23.8628011930874 13.287269109737224 0.11480652951682047 ;
	setAttr ".r" -type "double3" 338.66164726279015 -990.59999999990703 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9782D050-4246-7DC1-95B9-569556D9DC10";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 22.715143077780294;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 2.7059897705130895 5.0218008300651276 -0.1067551806234377 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "455B9A4D-4630-2D54-8F0E-1E97A472133A";
	setAttr ".t" -type "double3" 2.7786439732034189 1000.7380197602106 -0.12757110411458328 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "CD25069C-4E86-4FF6-DFF5-44A427078552";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 988.18010271192804;
	setAttr ".ow" 99.518612311990026;
	setAttr ".imn" -type "string" "top";
	setAttr ".den" -type "string" "top_depth";
	setAttr ".man" -type "string" "top_mask";
	setAttr ".tp" -type "double3" 2.7786439732034176 12.557917048282272 -0.12757110411480266 ;
	setAttr ".hc" -type "string" "viewSet -t %camera";
	setAttr ".o" yes;
createNode transform -s -n "front";
	rename -uid "7FAF6DF8-4D02-0731-EDCF-FDBC60646341";
	setAttr ".t" -type "double3" 2.7786439732034243 -25.65664704833911 1006.6670443020615 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "4991A442-4AAF-CDC9-5B07-78ABF20873CB";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1006.7946154061764;
	setAttr ".ow" 714.93080330762507;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" 2.7786439732034247 -25.65664704833911 -0.12757110411480266 ;
	setAttr ".hc" -type "string" "viewSet -f %camera";
	setAttr ".o" yes;
createNode transform -s -n "side";
	rename -uid "7D39DBBD-46B1-3125-0DD0-738780A19466";
	setAttr ".t" -type "double3" 1003.4703274126324 12.55791704828227 -0.12757110411458061 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "1A518737-4730-0849-A7F3-F89285F523FA";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.6916834394287;
	setAttr ".ow" 188.16736243250966;
...
createNode transform -n "pasted__pCube2" -p "group";
	...
	setAttr ".t" -type "double3" -1.4866633484246075 -0.9608309475973118 -16.216203097671862 ;
	setAttr ".s" -type "double3" 4.6675445962939204 3.3475900361777806 2.9691558247252461 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "26ADBBEC-4157-3198-49A3-9AA6E5A847DC";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D63742B3-4C2C-D8F8-3DEC-448CE4D137EE";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2870448A-498D-01BD-0ABE-0EBC42AB3715";
createNode displayLayerManager -n "layerManager";
	rename -uid "B3008B6A-42B7-2B3F-29A9-0A9C79B767D1";
createNode displayLayer -n "defaultLayer";
	rename -uid "66365728-484F-D6A7-27E2-ABADE6D3618E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DFA20B21-47E2-4861-70CA-BFBFA4450B14";
